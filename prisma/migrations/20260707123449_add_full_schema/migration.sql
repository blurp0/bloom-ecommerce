...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('COD', 'EWALLET', 'MANUAL');

-- CreateEnum
CREATE TYPE "CustomRequestStatus" AS ENUM ('PENDING', 'PROPOSED', 'APPROVED', 'REJECTED');
...
-- CreateIndex
CREATE INDEX "CustomRequest_userId_status_idx" ON "CustomRequest"("userId", "status");

-- CreateIndex
CREATE INDEX "CustomRequest_status_idx" ON "CustomRequest"("status");

-- CreateIndex
CREATE UNIQUE INDEX "Proposal_customRequestId_key" ON "Proposal"("customRequestId");

-- CreateIndex
CREATE INDEX "Proposal_customRequestId_idx" ON "Proposal"("customRequestId");
...
-- AddForeignKey
ALTER TABLE "Proposal" ADD CONSTRAINT "Proposal_customRequestId_fkey" FOREIGN KEY ("customRequestId") REFERENCES "CustomRequest"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
